...
let foodArray = [ 'Pho', 'Papaya Salad', 'Ban-mi'];
...
foodArray.push('Kapoon');
console.log('Added a new food at the end', foodArray);
...
console.log('Removed the first food on the list');
console.log('The favorite foods are now', foodArray);
